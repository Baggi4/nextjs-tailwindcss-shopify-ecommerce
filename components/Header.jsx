...
const offers = [
  { name: 'until February 10', description: '$5 for your 1st order', href: '#' },
  { name: "Return when you're ready", description: '60 days of free returns', href: '#' },
  { name: 'Sign up for our newsletter', description: '15% off your first order with code KANAP2023', href: '#' },
]
...
export default function Header() {
  ...
  return (
    <div className="stone-50 shadow-md">
      {/* Mobile menu */}
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="hidden lg:flex lg:items-center">
                    <a href="#">
                      <span className="sr-only">Kanap</span>
                      <Image
